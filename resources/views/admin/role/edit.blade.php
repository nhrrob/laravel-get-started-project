                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <div class="flex items-center space-x-2">
                                        <input id="checkPermissionAll" type="checkbox" value="1" {{ auth()->user()->roleHasPermissions($role, $allPermissions) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500" />
                                ...
                                <div class="flex flex-wrap items-start space-y-2">
                                    ...
                                    <div class="w-full md:w-1/4">
                                        <div class="flex items-center space-x-2">
                                            <input id="{{$i}}Management" type="checkbox" name="group[]" value="{{$group->group_name}}" onclick="checkPermissionByGroup('role-{{$i}}-management-checkbox', this)" {{ auth()->user()->roleHasPermissions($role, $permissions) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500" />
                                    ...
                                    <div class="w-full md:w-3/4 role-{{$i}}-management-checkbox space-y-1">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <input id="checkPermission{{$permission->id}}" type="checkbox" name="permissions[]" value="{{$permission->name}}" onclick="checkSinglePermission('role-{{$i}}-management-checkbox', '{{$i}}Management', {{count($permissions)}})" {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500" />
